...
When you go to the **Discussion** page in your course, you'll see a page that looks like the following.
...
.. image:: /Images/SFD_DiscussionHome.png
   :width: 500
   :alt: Discussion home page with a topics pane on the left side and "How to use edX discussions" pane on the right

In the left pane, you'll see all the posts that other students or course staff have added to the discussion. A *post* is a comment or question that opens a discussion. 



The discussions for each course are organized into individual *topics*.  

Students and course staff create posts about specific topics. Other students and course staff then either reply to a post or comment on a post.

Image of a **Discussion** page
...
*Content-specific* discussion topics cover specific video lectures,
reading assignments, homework problems, or other course content. When these
...
*Course-wide* discussion topics cover matters that affect the entire course, and may include topics such as "Frequently Asked Questions" and "Troubleshooting". You access these topics on the **Discussion** page of the course: click **All Discussions**
...
.. need a better idea of what's going on in this shot - has someone already clicked All Discussions? Also, course-wide topics are flush left

You can also see course-specific topics on the **Discussion** page
